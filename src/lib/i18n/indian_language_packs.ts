...
export const INDIAN_LANGUAGE_PACKS: Record<string, LanguagePack> = {
  ...
  TA: {
    ...
    labels: {
      ...
      opdQueue: 'OPD காத்திருப்பு வரிசை & UHI',
      ...
      opdCareSuite: 'OPD & நோயாளி பராமரிப்பு',
      ...
      opdQueueManagerTitle: 'OPD காத்திருப்பு வரிசை மேலாளர் & UHI டெலிஹெல்த்',
      opdQueueManagerSub: 'தேசிய சுகாதார ஆணையம் (NHA UHI v1.2) நோயாளி ஓட்டம்',
      checkInWalkInPatient: '+ புதிய நோயாளி பதிவு செய்',
      physicalOpdTokenQueue: 'கிளினிக் டோக்கன் காத்திருப்பு வரிசை',
      inOpdCabin: 'ஆலோசனையில்',
      callToken: 'அடுத்தவரை அழை',
      ...
      switchRbacLogin: 'பயனர் பங்கை மாற்று',
      logOut: 'வெளியேறு',
    },
  },
  DE: {
