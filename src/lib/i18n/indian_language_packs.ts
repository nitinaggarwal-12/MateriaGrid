...
export const INDIAN_LANGUAGE_PACKS: Record<IndianLanguageCode, LanguagePack> = {
  ...
  ML: {
    ...
    labels: {
      ...
      clinicalAnalytics: 'ക്ലിനിക്കൽ അനലിറ്റിക്സ്',
      aiCopilot: 'AI ക്ലിനിക്കൽ കോപൈലറ്റ്',
      patientEhr: 'രോഗി EHR & ABHA',
      materiaMedica: 'മറ്റീരിയ മെഡിക്ക ലൈബ്രറി',
      opdQueue: 'OPD കാത്തിരിപ്പ് നിര',
      pharmacy: 'ഫാർമസിയും LM പൊട്ടൻസിയും',
      differentialWorkbench: 'തുലന പട്ടിക',
    },
  },
  TE: {
    code: 'TE',
    ...
    labels: {
      ...
      clinicalAnalytics: 'క్లినికల్ అనలిటిక్స్',
      aiCopilot: 'AI క్లినికల్ సహాయకుడు',
      patientEhr: 'రోగి EHR & ABHA',
      materiaMedica: 'మెటీరియా మెడికా గ్రంథాలయం',
      opdQueue: 'OPD నిరీక్షణ వరుస',
      pharmacy: 'ఫార్మసీ & LM పొటెన్సీ',
      differentialWorkbench: 'పోలిక పట్టిక',
    },
  },
  KN: {
    code: 'KN',
    ...
    labels: {
      ...
      clinicalAnalytics: 'ಕ್ಲಿನಿಕಲ್ ಅನಾಲಿಟಿಕ್ಸ್',
      aiCopilot: 'AI ಕ್ಲಿನಿಕಲ್ ಸಹಾಯಕ',
      patientEhr: 'ರೋಗಿ EHR & ABHA',
      materiaMedica: 'ಮೆಟೀರಿಯಾ ಮೆಡಿಕಾ ಗ್ರಂಥಾಲಯ',
      opdQueue: 'OPD ಕಾಯುವ ಸಾಲು',
      pharmacy: 'ಫಾರ್ಮಸಿ & LM ಪೊಟೆನ್ಸಿ',
      differentialWorkbench: 'ತೌಲನಿಕ ಕೋಷ್ಟಕ',
    },
  },
  OR: {
    code: 'OR',
    ...
    labels: {
      ...
      clinicalAnalytics: 'କ୍ଲିନିକାଲ୍ ଆନାଲିଟିକ୍ସ',
      aiCopilot: 'AI କ୍ଲିନିକାଲ୍ କୋପାଇଲଟ୍',
      patientEhr: 'ରୋଗୀ EHR ଓ ABHA',
      materiaMedica: 'ମଟେରିଆ ମେଡିକା ଲାଇବ୍ରେରୀ',
      opdQueue: 'OPD ଅପେକ୍ଷା ତାଲିକା',
      pharmacy: 'ଫାର୍ମାସୀ ଓ LM ପୋଟେନ୍ସି',
      differentialWorkbench: 'ତୁଳନାତ୍ମକ ଟେବୁଲ୍',
    },
  },
  PA: {
    code: 'PA',
    ...
    labels: {
      ...
      clinicalAnalytics: 'ਕਲੀਨਿਕਲ ਐਨਾਲਿਟਿਕਸ',
      aiCopilot: 'AI ਕਲੀਨਿਕਲ ਕੋਪਾਇਲਟ',
      patientEhr: 'ਮਰੀਜ਼ EHR ਅਤੇ ABHA',
      materiaMedica: 'ਮਟੇਰੀਆ ਮੈਡਿਕਾ ਲਾਇਬ੍ਰੇਰੀ',
      opdQueue: 'OPD ਉਡੀਕ ਸੂਚੀ',
      pharmacy: 'ਫਾਰਮੇਸੀ ਅਤੇ LM ਪੋਟੈਂਸੀ',
      differentialWorkbench: 'ਤੁਲਨਾਤਮਕ ਸਾਰਣੀ',
    },
  },
  UR: {
    code: 'UR',
    ...
    labels: {
      ...
      clinicalAnalytics: 'کلینیکل تجزیا ت',
      aiCopilot: 'AI کلینیکل کوپائلٹ',
      patientEhr: 'مریض EHR اور ABHA',
      materiaMedica: 'مٹیریا میڈیکا لائبریری',
      opdQueue: 'OPD انتظار گاہ',
      pharmacy: 'فارمیسی اور LM پوٹینسی',
      differentialWorkbench: 'تقابلی جدول',
    },
  },
  DE: {
    code: 'DE',
